...
//      模块通道    端口          可选范围              建议
#define I2C0_SCL_PIN    PTB0        // PTB0、PTB2、PTD8
#define I2C0_SDA_PIN    PTB1        // PTB1、PTB3、PTD9
...
#define SPI0_PCS0_PIN   PTA17       // PTA14、PTC4、PTD0、      全部都是 ALT2
...
#define SPI1_PCS0_PIN   PTA17       // PTE4、PTB10、            全部都是 ALT2
