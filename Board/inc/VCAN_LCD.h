...
void LCD_get_size(Size_t *size);                                                                        //获取LCD分辨率
...
//extern void LCD_DISPLAYhql();//
extern void LCD_curve_hql(Site_t start,uint8 *cline,uint8 maxval,uint16 Color) ;
extern void LCD_num_BCHQL(Site_t site, int32 num, uint8 max_num_bit, uint16 Color, uint16 bkColor)  ;
